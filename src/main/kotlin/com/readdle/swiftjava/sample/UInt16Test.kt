...
class UInt16Test private constructor() {
    ...
    companion object {
        ...
        @JvmStatic
        external fun testBlock(@SwiftBlock block: KotlinUInt16Block): Boolean

        @JvmStatic
        external fun testOptionalBlock(@SwiftBlock block: KotlinOptionalUInt16Block): Boolean
    }
