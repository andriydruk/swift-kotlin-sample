...
class Int8Test private constructor() {
    ...
    companion object {
        ...
        @JvmStatic
        external fun testBlock(@SwiftBlock block: KotlinInt8Block): Boolean

        @JvmStatic
        external fun testOptionalBlock(@SwiftBlock block: KotlinOptionalInt8Block): Boolean
    }
