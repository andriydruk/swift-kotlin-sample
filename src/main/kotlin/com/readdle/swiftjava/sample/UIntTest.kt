...
class UIntTest private constructor() {
    ...
    companion object {
        ...
        @JvmStatic
        external fun testBlock(@SwiftBlock block: KotlinUIntBlock): Boolean

        @JvmStatic
        external fun testOptionalBlock(@SwiftBlock block: KotlinOptionalUIntBlock): Boolean
    }
