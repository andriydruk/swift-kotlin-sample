...
class Int16Test private constructor() {
    ...
    companion object {
        ...
        @JvmStatic
        external fun testBlock(@SwiftBlock block: KotlinInt16Block): Boolean

        @JvmStatic
        external fun testOptionalBlock(@SwiftBlock block: KotlinOptionalInt16Block): Boolean
    }
