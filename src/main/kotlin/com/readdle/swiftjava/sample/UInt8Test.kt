...
class UInt8Test private constructor() {
    ...
    companion object {
        ...
        @JvmStatic
        external fun testBlock(@SwiftBlock block: KotlinUInt8Block): Boolean

        @JvmStatic
        external fun testOptionalBlock(@SwiftBlock block: KotlinOptionalUInt8Block): Boolean
    }
